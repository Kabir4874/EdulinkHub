...
if ($book_id > 0) {
    ...
    if ($result->num_rows > 0) {
        ...
        $review_stmt = $conn->prepare("SELECT * FROM books WHERE id = ? ORDER BY createdAt DESC");
                    ...
                    <?php foreach ($reviews as $review): ?>
                        <div class="review-card">
                            <div class="review-header">
                                <span class="review-author"><?= htmlspecialchars($review['author'] ?? 'Anonymous') ?></span>
                                <span class="review-date"><?= date('M d, Y H:i', strtotime($review['createdAt'])) ?></span>
                            </div>
