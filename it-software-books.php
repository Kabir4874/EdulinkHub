...
<head>
  ...
  <title>IT & Software Books - EdUHub</title>
  <link rel="icon" href="../images/logo.png" type="image/png">
  <link rel="stylesheet" href="../CSS/it-software-books.css" />
...
<nav class="navbar">
  ...
  <!-- Hero Section -->
  <section class="hero book-hero-it">
    <div class="hero-content">
      <h1>IT & Software Books</h1>
      <p>Master software, networks, cybersecurity, and IT tools with expert resources.</p>
    </div>
  </section>
  ...
  <section class="book-section">
    <div class="container">
      <div class="book-card">
        <img src="images/software-engineering.jpg" alt="Software Engineering Book" />
        <h3>Software Engineering</h3>
        <p>Author: Ian Sommerville</p>
        <p>Price: 35 Taka </p>
        <button onclick="addToCart('Software Engineering')">Add to Cart</button>
        
      </div>
      <div class="book-card">
        <img src="images/networking.jpg" alt="Computer Networking Book" />
        <h3>Computer Networking</h3>
        <p>Author: Kurose & Ross</p>
        <p>Price: 40 Taka </p>
        <button onclick="addToCart('Computer Networking')">Add to Cart</button>
      </div>
      <div class="book-card">
        <img src="images/cybersecurity.jpg" alt="Cybersecurity Essentials" />
        <h3>Cybersecurity Essentials</h3>
        <p>Author: Charles J. Brooks</p>
        <p>Price: 32 Taka</p>
        <button onclick="addToCart('Cybersecurity Essentials')">Add to Cart</button>
      </div>
    </div>
  </section>
