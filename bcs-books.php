...
<head>
  ...
  <title>BCS Books - EdUHub</title>
  <link rel="icon" href="../images/logo.png" type="image/png" />
  <link rel="stylesheet" href="../CSS/bcs-books.css" />
...
<!-- Hero -->
<section class="hero book-hero-bcs">
  <div class="hero-content">
    <h1>BCS Preparation Books</h1>
    <p>Crack the BCS exam with top-rated preparation and guide books.</p>
  </div>
</section>
...
<section class="book-section">
  <div class="book-grid">
    <div class="book-card">
      <img src="../images/bcs1.jpg" alt="BCS Bangla">
      <h3>BCS Bangla Guide</h3>
      <p>Price: ৳45</p>
      <button onclick="addToCart('BCS Bangla Guide')">Add to Cart</button>
    </div>
    <div class="book-card">
      <img src="../images/bcs2.jpg" alt="BCS General Knowledge">
      <h3>BCS General Knowledge</h3>
      <p>Price: ৳50</p>
      <button onclick="addToCart('BCS General Knowledge')">Add to Cart</button>
    </div>
    <div class="book-card">
      <img src="../images/bcs3.jpg" alt="BCS English">
      <h3>BCS English</h3>
      <p>Price: ৳40</p>
      <button onclick="addToCart('BCS English')">Add to Cart</button>
    </div>
    <div class="book-card">
      <img src="../images/bcs4.jpg" alt="BCS Math">
      <h3>BCS Math</h3>
      <p>Price: ৳55</p>
      <button onclick="addToCart('BCS Math')">Add to Cart</button>
    </div>
  </div>
</section>
...
document.addEventListener('click', () => document.getElementById('userProfile').classList.remove('active'));
...
const bookData = {
  "BCS Bangla Guide": 45,
  "BCS General Knowledge": 50,
  "BCS English": 40,
  "BCS Science & Technology": 55
};
...
function updateQuantity(bookName, action) {
  ...
  cart.forEach(item => {
    ...
    cartItemsContainer.innerHTML += `
      <div class="cart-item">
        ...
        <button onclick="removeFromCart('${item.name}')" style="background:red; color:white; border:none; padding:4px 8px; border-radius:4px;">Remove</button>
      </div>`;
  });
...
// Cart dropdown
document.getElementById("cartIconContainer").addEventListener("click", function (e) {
  e.stopPropagation();
  document.getElementById("cartDropdown").classList.toggle("show");
});
document.addEventListener("click", () => document.getElementById("cartDropdown").classList.remove("show"));
</script>
